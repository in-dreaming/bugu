...
| T013 | REVIEW | [GPU propagation 设计与 spike](T013-gpu-propagation-design-spike.md) | Research+Prototype | T010,T012 | [GPU acoustic propagation design](../design/gpu-acoustic-propagation.md)、capability probe |
